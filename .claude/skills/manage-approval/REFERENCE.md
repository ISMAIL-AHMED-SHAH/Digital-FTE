# Manage Approval Reference

Detailed documentation for the manage-approval skill. This file is loaded only when the agent needs deep configuration details.
